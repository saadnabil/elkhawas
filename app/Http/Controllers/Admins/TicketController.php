...
class TicketController extends Controller
{
    ...
    public function mytickets(){
        ...
        return response()->view('admin.tickets.mytickets', compact('tickets'));
    }

    public function index()
    {
        $tickets = Ticket::latest()->paginate(8);
        return response()->view('admin.tickets.index', compact('tickets'));
    }
    ...
    public function edit(Request $request, Ticket $ticket)
    {
        ...
        return response()->view('admin.tickets.form', compact('ticket', 'action', 'method','admins'));
    }

    public function update(ValidateTicketForm $request, Ticket $ticket)
    {
