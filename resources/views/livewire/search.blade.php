                                ...
                                <div class="text-center">
                                    ...
                                    <ul style="border-color: #666666 !important;margin-top:20px;"
                                        ...
                                        <li style="margin-top:10px;">
                                            ...
                                            @endif
                                            <a style="border-radius: 0 !important;" data-route="{{ route('wishlist.favourite', $item) }}" onclick=""
                                                type="button"
                        ...
                        <div class="card text-center mb-3">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    ...
                                    <span
                                        class="badge bg-info">€{{ number_format($item->unit_price, 2, ',', '.') }}</span>
                                </h5>

                                <p class="card-text mb-3">Main Price:
                                    <span
                                        class="badge bg-primary">€{{ number_format($item->total_price, 2, ',', '.') }}</span>
                                </p>
                                @if ($item->quantity > 0)
