...
<div class="col-md-8 ">
  <div class="card">
    <div class="card-body">
      ...
      <form action="" method="POST" autocomplete="off">
        <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <img width="100" height="100" src="{{ asset('elkhawas/elkhawas_images/Baba-Ganoush-.jpg') }}" alt="not found" />
      ...
      <button onclick="successIcon()" type="button" class="btn btn-primary submit">Confirm Edit</button>
    </div>
  </div>
  <script>
    function successIcon() {
  Swal.fire({
      html: '<h3 class="text-success"> Edited product Successfully</h3>',
      icon: 'success'
  })
}
  </script>
