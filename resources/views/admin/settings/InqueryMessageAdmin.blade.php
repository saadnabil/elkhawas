        ...
        <div class="card">
            <div class="card-body">
                ...
                <h6 style="color:#a0890e" class="">
                 <strong style="color:red">  ( {{ $message->user ? $message->user->name : 'Unknown User' }}) </strong>Request Message
                </h6>
...
<div class="col-md-6 ">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('admin.RepleyMessageToUser')}}" method="POST" autocomplete="off">
                @csrf
