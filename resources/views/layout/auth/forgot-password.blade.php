          ...
          <div class="row g-0">
            <div class="col-12 col-md-6">
              <img class="img-fluid rounded-start w-100 h-100 object-fit-cover"
               loading="lazy" src="{{asset('images/forgitpassword.avif')}}" alt="Welcome back you've been missed!">
            </div>
                    ...
                    <div class="col-12">
                      <div class="mb-5">
                        <div class="text-center mb-4">
                          <a href="#!">
                            <img src="{{asset('elkhawas/elkhawas_images/elkhawas.png')}}" alt="BootstrapBrain Logo" width="175" height="57">
                          </a>
                        </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-center mt-5">
                        <a type="button" href="{{route('admin.login')}}" class="btn btn-primary">Back to Login</a>
                      </div>
                    </div>
                  </div>
                </div>
